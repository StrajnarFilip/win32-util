...
def find_window_w(class_name: Union[str, None],
    ...
    More information on: https://learn.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-findwindoww
    """
...
def set_foreground_window(window_handle: int):
    ...
    """
    current_foreground_window = windll.User32.GetForegroundWindow()
